 ...
 * Programación orientada a objetos. Clase Monstruo - clase abstracta que
...
public abstract class Monstruo extends Personaje {
	 ...
	 * su posición es nula (fuera del tablero)
	 * 
	...
	/**
	 * El monstruo defiende de un ataque (Implementación de método abstracto
	 * heredado)
	 * 
